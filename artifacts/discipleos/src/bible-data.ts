...
const RAW_VERSE_COUNTS: Record<string, number[]> = {
  ...
  Leviticus:        [17,16,17,35,19,30,38,36,24,20,47,8,59,57,33,34,16,30,24,29,35,45,43,14,21,11,13],
  Numbers:          [54,34,51,49,31,27,89,26,23,36,35,16,33,45,41,35,28,32,22,29,35,41,30,25,18,65,23,31,40,16,54,42,56,29,34,13],
  ...
  "2 Kings":        [18,25,27,44,27,33,20,29,37,36,21,21,25,29,38,20,41,37,37,21,26,20,37,20],
  ...
  Psalms:           [6,12,8,8,12,10,17,9,20,18,7,8,6,7,5,11,15,50,14,9,13,31,6,10,22,12,14,9,11,12,24,11,22,22,28,12,40,22,13,17,13,11,5,20,28,22,35,22,24,23,29,10,19,6,7,40,14,25,18,8,8,9,16,24,14,15,6,15,21,15,16,5,7,21,8,13,26,40,37,16,7,15,18,17,15,11,35,16,20,28,4,17,5,6,6,7,4,5,2,29,35,14,4,13,13,20,4,17,10,33,9,6,8,42,16,24,21,15,5,14,18,33,15,23,29,35,41,22,26,14,3,11,13,7,6,40,23,29,46,18,17,19,26,10,5,10,22,8,26,44,22,25,17,22,23,12,5,11,13,26,5,21,28,31,18,19,7,17,27,10,22,23,5,41,16,24,6,8,9,20,14,14,10,14,8,9,14,32,9,8,13,5,11,12,8,10,9,10,13,6,3,7,10,13,17,15,4,9,6,3,4,2,6,9,3,10,6,9,8,7,8,10,8,4,5,13,7,8,4,8,9,5,7,6,7,10,7,5,8,6,7,9,8,7,6,7,9,9,5,6,4,8,10,9,8,7,7,8,6,9],
  Proverbs:         [33,22,35,27,23,35,27,36,18,32,31,28,25,35,33,33,28,24,29,30,31,29,35,34,28,28,27,28,27,33,31],
  Ecclesiastes:     [18,26,22,17,19,11,30,21,18,26,33,18],
  "Song of Solomon":[17,17,11,16,16,13,13,14],
  Isaiah:           [31,22,26,6,30,13,25,22,21,34,16,6,22,32,9,14,14,7,25,6,17,25,18,23,12,21,13,29,24,33,9,20,24,21,29,2,22,24,17,22,25,12,16,15,19,14,20,11,7,13,15,12,11,9,18,14,14,20,13,15,11,17,16,19,17,12],
  ...
  Ezekiel:          [28,10,27,21,17,21,11,20,12,28,33,18,24,29,30,14,10,22,23,14,25,20,22,22,14,22,26,18,16,24,22,23,22,20,22,25,25,16,29,29,18,37,19,19,27,28,44,21],
  Daniel:           [21,49,30,37,31,28,28,27,27,21,45,13],
  Hosea:            [11,23,5,19,15,11,16,14,17,15,12,14,16,9],
  Joel:             [20,32,21],
  Amos:             [15,16,15,13,27,14,17,14,21],
  Obadiah:          [21],
  Jonah:            [17,10,10,11],
  ...
  // ── New Testament ──────────────────────────────────────────────────────────
  Matthew:          [25,23,17,25,48,34,29,34,38,42,45,50,58,36,39,28,27,35,30,34,46,46,39,51,46,75,66,20],
  Mark:             [45,28,35,41,43,56,37,38,50,52,33,44,37,72,47,20],
  Luke:             [80,52,38,44,39,49,50,56,62,42,54,59,35,35,32,31,37,43,48,47,38,71,56,53],
  John:             [51,25,36,54,47,71,53,59,41,42,57,50,38,31,27,33,26,40,42,31,25],
  Acts:             [26,47,26,37,42,15,60,40,43,48,30,25,52,28,41,40,34,28,41,38,40,30,35,27,27,32,44,31],
  Romans:           [32,29,31,25,21,23,25,39,33,21,36,21,14,26,33,25],
  "1 Corinthians":  [31,16,23,21,13,20,40,34,16,27,33,12,21,20,28,36],
  "2 Corinthians":  [24,17,18,18,21,18,16,24,15,18,33,21,14],
  Galatians:        [24,21,29,31,26,18],
  Ephesians:        [23,22,21,28,20,21],
...
export function estimateDayMinutes(readings: Array<{ book: string; chapter: number }>): number {
  return readings.reduce((sum, r) => sum + estimateChapterMinutes(r.book, r.chapter), 0);
}

/** Total estimated minutes to read a set of books cover-to-cover */
export function estimateBooksMinutes(selectedBooks: string[]): number {
